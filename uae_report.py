...
query = "Select uae_sfcc from analytics"
...
with open_file('orders_uae.csv', 'r') as infile:
    saved_df.to_csv('orders_uae.csv', mode='a', header=False)

connection = sqlite3.connect('analytics_sfcc.db')
query = "Update analytics set uae_sfcc = ?"
cursor = connection.cursor()
